...
Restaurant.create(name: 'japanese', address: 'japanese street', phone_number: '+813474224094', category: 'japanese')
Restaurant.create(name: 'belgian', address: 'Rue belgian', phone_number: '+323474224091', category: 'belgian')
